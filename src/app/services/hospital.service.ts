...
export class HospitalService {
  // deployed app url https://hospital-app-node.herokuapp.com
   ...
   */
  public getDepartmentData(): Observable<IDepartmentData[]> {
    return this.http.get<Array<IDepartmentData>>(`${this.baseUrl}/department`);
  }
